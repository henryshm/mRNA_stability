...
###### CDS nucleotide
fscore_avg_HalfLife_leadered_CDSnucleotide <- read.table('../ml_metrics_halfLifeClass/HalfLifeCls_logPhase_nonSelected_leadered_byType_CDSnucleotide_fscore_avg.txt')
fscore_avg_HalfLife_leaderless_CDSnucleotide <- read.table('../ml_metrics_halfLifeClass/HalfLifeCls_logPhase_nonSelected_leaderless_byType_CDSnucleotide_fscore_avg.txt')
...
ggsave("./viz_deltaFscores_toCompareTranscript/deltaFscores_avgs_toCompareTranscriptType_CDSnucleotide_logPhase.png", width = 8, height = 20, units = "cm", dpi = 600)

###### CDS MFE
fscore_avg_HalfLife_leadered_CDSmfe <- read.table('../ml_metrics_halfLifeClass/HalfLifeCls_logPhase_nonSelected_leadered_byType_CDSmfe_fscore_avg.txt')
fscore_avg_HalfLife_leaderless_CDSmfe <- read.table('../ml_metrics_halfLifeClass/HalfLifeCls_logPhase_nonSelected_leaderless_byType_CDSmfe_fscore_avg.txt')
...
ggsave("./viz_deltaFscores_toCompareTranscript/deltaFscores_avgs_toCompareTranscriptType_CDSmfe_logPhase.png", width = 8, height = 20, units = "cm", dpi = 600)

###### Codon
fscore_avg_HalfLife_leadered_Codon <- read.table('../ml_metrics_halfLifeClass/HalfLifeCls_logPhase_nonSelected_leadered_byType_Codon_fscore_avg.txt')
fscore_avg_HalfLife_leaderless_Codon <- read.table('../ml_metrics_halfLifeClass/HalfLifeCls_logPhase_nonSelected_leaderless_byType_Codon_fscore_avg.txt')
...
ggsave("./viz_deltaFscores_toCompareTranscript/deltaFscores_avgs_toCompareTranscriptType_Codon_logPhase.png", width = 8, height = 20, units = "cm", dpi = 600)

###### Translation
fscore_avg_HalfLife_leadered_Translation <- read.table('../ml_metrics_halfLifeClass/HalfLifeCls_logPhase_nonSelected_leadered_byType_Translation_fscore_avg.txt')
fscore_avg_HalfLife_leaderless_Translation <- read.table('../ml_metrics_halfLifeClass/HalfLifeCls_logPhase_nonSelected_leaderless_byType_Translation_fscore_avg.txt')
...
ggsave("./viz_deltaFscores_toCompareTranscript/deltaFscores_avgs_toCompareTranscriptType_Translation_logPhase.png", width = 8, height = 20, units = "cm", dpi = 600)

###### Others
fscore_avg_HalfLife_leadered_Others <- read.table('../ml_metrics_halfLifeClass/HalfLifeCls_logPhase_nonSelected_leadered_byType_Others_fscore_avg.txt')
fscore_avg_HalfLife_leaderless_Others <- read.table('../ml_metrics_halfLifeClass/HalfLifeCls_logPhase_nonSelected_leaderless_byType_Others_fscore_avg.txt')
...
ggsave("./viz_deltaFscores_toCompareTranscript/deltaFscores_avgs_toCompareTranscriptType_Others_logPhase.png", width = 8, height = 20, units = "cm", dpi = 600)

###### combined selected
fscore_avg_HalfLife_leadered_CombinedSelected <- read.table('../ml_metrics_halfLifeClass/HalfLifeCls_logPhase_combinedSelected_leadered_byLeaderlessLogPhase_jointlyByLeaderedLeaderless_fscore_avg.txt')
fscore_avg_HalfLife_leaderless_CombinedSelected <- read.table('../ml_metrics_halfLifeClass/HalfLifeCls_logPhase_combinedSelected_leaderless_byLeaderlessLogPhase_jointlyByLeaderedLeaderless_fscore_avg.txt')
...
ggsave("./viz_deltaFscores_toCompareTranscript/deltaFscores_avgs_toCompareTranscriptType_Combined_CombinedSelectedByLeaderless_logPhase.png", width = 8, height = 20, units = "cm", dpi = 600)
