...
SHAP_vals_Fast <- read.csv('../SHAP_values/SHAPvals_HalfLifeCls_logPhase_combinedSelected_leaderless_byLeaderlessLogPhase_jointlyByLogPhaseHypoxia_Fast.csv') %>% 
  mutate(class = 'Fast')
SHAP_vals_MedFast <- read.csv('../SHAP_values/SHAPvals_HalfLifeCls_logPhase_combinedSelected_leaderless_byLeaderlessLogPhase_jointlyByLogPhaseHypoxia_MedFast.csv') %>% 
  mutate(class = 'MedFast')
SHAP_vals_MedSlow <- read.csv('../SHAP_values/SHAPvals_HalfLifeCls_logPhase_combinedSelected_leaderless_byLeaderlessLogPhase_jointlyByLogPhaseHypoxia_MedSlow.csv') %>% 
  mutate(class = 'MedSlow')
SHAP_vals_Slow <- read.csv('../SHAP_values/SHAPvals_HalfLifeCls_logPhase_combinedSelected_leaderless_byLeaderlessLogPhase_jointlyByLogPhaseHypoxia_Slow.csv') %>% 
  mutate(class = 'Slow')
...
SHAP_Nucl_A_CDS_5p18nt %>% 
  ...
  coord_flip()
ggsave("./viz_SHAPvalues_toCompareCondition_leaderless/SHAPvalueTop20combined_toCompareCondition_HalfLifeCls_logPhase_combinedSelectedByLeaderlessLogPhase_jointlyByLogPhaseHypoxia_leaderless_Nucl_A_CDS_5p18nt.png", width = 55, height = 22, units = "cm", dpi = 600)
...
SHAP_GC_CDS_5p18nt %>% 
  ...
  coord_flip()
ggsave("./viz_SHAPvalues_toCompareCondition_leaderless/SHAPvalueTop20combined_toCompareCondition_HalfLifeCls_logPhase_combinedSelectedByLeaderlessLogPhase_jointlyByLogPhaseHypoxia_leaderless_GC_CDS_5p18nt.png", width = 55, height = 22, units = "cm", dpi = 600)
...
SHAP_CDS_MFE_50_25nt_5p %>% 
  ...
  coord_flip()
ggsave("./viz_SHAPvalues_toCompareCondition_leaderless/SHAPvalueTop20combined_toCompareCondition_HalfLifeCls_logPhase_combinedSelectedByLeaderlessLogPhase_jointlyByLogPhaseHypoxia_leaderless_CDS_MFE_50_25nt_5p.png", width = 55, height = 22, units = "cm", dpi = 600)
...
SHAP_CDS_MFE_20_10nt_mid %>% 
  ...
  coord_flip()
ggsave("./viz_SHAPvalues_toCompareCondition_leaderless/SHAPvalueTop20combined_toCompareCondition_HalfLifeCls_logPhase_combinedSelectedByLeaderlessLogPhase_jointlyByLogPhaseHypoxia_leaderless_CDS_MFE_20_10nt_mid.png", width = 55, height = 22, units = "cm", dpi = 600)
...
SHAP_CDS_MFE_50_25nt_3p %>% 
  ...
  coord_flip()
ggsave("./viz_SHAPvalues_toCompareCondition_leaderless/SHAPvalueTop20combined_toCompareCondition_HalfLifeCls_logPhase_combinedSelectedByLeaderlessLogPhase_jointlyByLogPhaseHypoxia_leaderless_CDS_MFE_50_25nt_3p.png", width = 55, height = 22, units = "cm", dpi = 600)
...
SHAP_adja_CG_CDS %>% 
  ...
  coord_flip()
ggsave("./viz_SHAPvalues_toCompareCondition_leaderless/SHAPvalueTop20combined_toCompareCondition_HalfLifeCls_logPhase_combinedSelectedByLeaderlessLogPhase_jointlyByLogPhaseHypoxia_leaderless_adja_CG_CDS.png", width = 55, height = 22, units = "cm", dpi = 600)
...
SHAP_adja_UA_CDS %>% 
  ...
  coord_flip()
ggsave("./viz_SHAPvalues_toCompareCondition_leaderless/SHAPvalueTop20combined_toCompareCondition_HalfLifeCls_logPhase_combinedSelectedByLeaderlessLogPhase_jointlyByLogPhaseHypoxia_leaderless_adja_UA_CDS.png", width = 55, height = 22, units = "cm", dpi = 600)

###### initialAbundance_logPhase
SHAP_vals_Fast_initialAbundance_logPhase <- SHAP_vals_Fast %>% 
  select(initialAbundance_logPhase, initialAbundance_logPhase_SHAP, class)
SHAP_vals_MedFast_initialAbundance_logPhase <- SHAP_vals_MedFast %>% 
  select(initialAbundance_logPhase, initialAbundance_logPhase_SHAP, class)
SHAP_vals_MedSlow_initialAbundance_logPhase <- SHAP_vals_MedSlow %>% 
  select(initialAbundance_logPhase, initialAbundance_logPhase_SHAP, class)
SHAP_vals_Slow_initialAbundance_logPhase <- SHAP_vals_Slow %>% 
  select(initialAbundance_logPhase, initialAbundance_logPhase_SHAP, class)

SHAP_initialAbundance_logPhase <- bind_rows(SHAP_vals_Slow_initialAbundance_logPhase, SHAP_vals_MedSlow_initialAbundance_logPhase,
                              SHAP_vals_MedFast_initialAbundance_logPhase, SHAP_vals_Fast_initialAbundance_logPhase) %>% 
  mutate(class = as.factor(class))

SHAP_initialAbundance_logPhase %>% 
  ggplot(aes(class, initialAbundance_logPhase_SHAP)) +
  geom_point(aes(color = initialAbundance_logPhase), 
             size = 7,
             alpha = 0.7,
             stroke = 0, 
             position = position_jitter(height = 0, width = 0.2, seed = 7)) +
  ...
  coord_flip()
ggsave("./viz_SHAPvalues_toCompareCondition_leaderless/SHAPvalueTop20combined_toCompareCondition_HalfLifeCls_logPhase_combinedSelectedByLeaderlessLogPhase_jointlyByLogPhaseHypoxia_leaderless_initialAbundance_logPhase.png", width = 55, height = 22, units = "cm", dpi = 600)
...
SHAP_CDS_length %>% 
  ...
  coord_flip()
ggsave("./viz_SHAPvalues_toCompareCondition_leaderless/SHAPvalueTop20combined_toCompareCondition_HalfLifeCls_logPhase_combinedSelectedByLeaderlessLogPhase_jointlyByLogPhaseHypoxia_leaderless_CDS_length.png", width = 55, height = 22, units = "cm", dpi = 600)
