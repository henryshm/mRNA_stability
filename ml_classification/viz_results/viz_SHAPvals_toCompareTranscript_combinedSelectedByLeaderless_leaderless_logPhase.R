...
SHAP_vals_Fast <- read.csv('../SHAP_values/SHAPvals_HalfLifeCls_logPhase_combinedSelected_leaderless_byLeaderlessLogPhase_jointlyByLeaderedLeaderless_Fast.csv') %>% 
  mutate(class = 'Fast')
SHAP_vals_MedFast <- read.csv('../SHAP_values/SHAPvals_HalfLifeCls_logPhase_combinedSelected_leaderless_byLeaderlessLogPhase_jointlyByLeaderedLeaderless_MedFast.csv') %>% 
  mutate(class = 'MedFast')
SHAP_vals_MedSlow <- read.csv('../SHAP_values/SHAPvals_HalfLifeCls_logPhase_combinedSelected_leaderless_byLeaderlessLogPhase_jointlyByLeaderedLeaderless_MedSlow.csv') %>% 
  mutate(class = 'MedSlow')
SHAP_vals_Slow <- read.csv('../SHAP_values/SHAPvals_HalfLifeCls_logPhase_combinedSelected_leaderless_byLeaderlessLogPhase_jointlyByLeaderedLeaderless_Slow.csv') %>% 
  mutate(class = 'Slow')
...
SHAP_CGC_CDSnstop %>% 
  ...
  coord_flip()
ggsave("./viz_SHAPvalues_toCompareTranscript_logPhase/SHAPvalueTop20combined_toCompareTranscript_HalfLifeCls_logPhase_combinedSelectedByLeaderlessLogPhase_jointlyByLeaderedLeaderless_leaderless_CGC_CDSnstop.png", width = 55, height = 22, units = "cm", dpi = 600)
...
SHAP_CGG_CDSnstop %>% 
  ...
  coord_flip()
ggsave("./viz_SHAPvalues_toCompareTranscript_logPhase/SHAPvalueTop20combined_toCompareTranscript_HalfLifeCls_logPhase_combinedSelectedByLeaderlessLogPhase_jointlyByLeaderedLeaderless_leaderless_CGG_CDSnstop.png", width = 55, height = 22, units = "cm", dpi = 600)
...
SHAP_UUG_CDSnstop %>% 
  ...
  coord_flip()
ggsave("./viz_SHAPvalues_toCompareTranscript_logPhase/SHAPvalueTop20combined_toCompareTranscript_HalfLifeCls_logPhase_combinedSelectedByLeaderlessLogPhase_jointlyByLeaderedLeaderless_leaderless_UUG_CDSnstop.png", width = 55, height = 22, units = "cm", dpi = 600)
...
SHAP_CGU_CDSnstop %>% 
  ...
  coord_flip()
ggsave("./viz_SHAPvalues_toCompareTranscript_logPhase/SHAPvalueTop20combined_toCompareTranscript_HalfLifeCls_logPhase_combinedSelectedByLeaderlessLogPhase_jointlyByLeaderedLeaderless_leaderless_CGU_CDSnstop.png", width = 55, height = 22, units = "cm", dpi = 600)
...
SHAP_CDS_MFE_20_10nt_mid %>% 
  ...
  coord_flip()
ggsave("./viz_SHAPvalues_toCompareTranscript_logPhase/SHAPvalueTop20combined_toCompareTranscript_HalfLifeCls_logPhase_combinedSelectedByLeaderlessLogPhase_jointlyByLeaderedLeaderless_leaderless_CDS_MFE_20_10nt_mid.png", width = 55, height = 22, units = "cm", dpi = 600)
...
SHAP_adja_CG_CDS %>% 
  ...
  coord_flip()
ggsave("./viz_SHAPvalues_toCompareTranscript_logPhase/SHAPvalueTop20combined_toCompareTranscript_HalfLifeCls_logPhase_combinedSelectedByLeaderlessLogPhase_jointlyByLeaderedLeaderless_leaderless_adja_CG_CDS.png", width = 55, height = 22, units = "cm", dpi = 600)
