...
SHAP_vals_Fast <- read.csv('../SHAP_values/SHAPvals_HalfLifeCls_logPhase_nonSelected_leadered_byType_5pUTR_UTRrelated_Fast.csv') %>% 
  mutate(class = 'Fast')
SHAP_vals_MedFast <- read.csv('../SHAP_values/SHAPvals_HalfLifeCls_logPhase_nonSelected_leadered_byType_5pUTR_UTRrelated_MedFast.csv') %>% 
  mutate(class = 'MedFast')
SHAP_vals_MedSlow <- read.csv('../SHAP_values/SHAPvals_HalfLifeCls_logPhase_nonSelected_leadered_byType_5pUTR_UTRrelated_MedSlow.csv') %>% 
  mutate(class = 'MedSlow')
SHAP_vals_Slow <- read.csv('../SHAP_values/SHAPvals_HalfLifeCls_logPhase_nonSelected_leadered_byType_5pUTR_UTRrelated_Slow.csv') %>% 
  mutate(class = 'Slow')
...
SHAP_adja_GC_5pUTR %>% 
  ...
  coord_flip()
ggsave("./viz_SHAPvalues_toCompareCondition_leadered_5pUTRonly_withUTRrelated/SHAPvalueTop20combined_toCompareCondition_HalfLifeCls_logPhase_nonSelected_leadered_5pUTRonly_withUTRrelated_adja_GC_5pUTR.png", width = 55, height = 22, units = "cm", dpi = 600)
...
SHAP_fprUTR_MFE_20_10nt_mid %>% 
  ...
  coord_flip()
ggsave("./viz_SHAPvalues_toCompareCondition_leadered_5pUTRonly_withUTRrelated/SHAPvalueTop20combined_toCompareCondition_HalfLifeCls_logPhase_nonSelected_leadered_5pUTRonly_withUTRrelated_fprUTR_MFE_20_10nt_mid.png", width = 55, height = 22, units = "cm", dpi = 600)
...
SHAP_GC_5pUTR %>% 
  ...
  coord_flip()
ggsave("./viz_SHAPvalues_toCompareCondition_leadered_5pUTRonly_withUTRrelated/SHAPvalueTop20combined_toCompareCondition_HalfLifeCls_logPhase_nonSelected_leadered_5pUTRonly_withUTRrelated_GC_5pUTR.png", width = 55, height = 22, units = "cm", dpi = 600)
...
SHAP_Nucl_T_5pUTR %>% 
  ...
  coord_flip()
ggsave("./viz_SHAPvalues_toCompareCondition_leadered_5pUTRonly_withUTRrelated/SHAPvalueTop20combined_toCompareCondition_HalfLifeCls_logPhase_nonSelected_leadered_5pUTRonly_withUTRrelated_Nucl_T_5pUTR.png", width = 55, height = 22, units = "cm", dpi = 600)
