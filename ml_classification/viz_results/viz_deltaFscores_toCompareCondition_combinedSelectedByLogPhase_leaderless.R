...
ggsave("./viz_deltaFscores_toCompareCondition/deltaFscores_avgs_toCompareConditionType_CDSnucleotide_leaderless.png", width = 8, height = 20, units = "cm", dpi = 600)
...
ggsave("./viz_deltaFscores_toCompareCondition/deltaFscores_avgs_toCompareConditionType_CDSmfe_leaderless.png", width = 8, height = 20, units = "cm", dpi = 600)
...
ggsave("./viz_deltaFscores_toCompareCondition/deltaFscores_avgs_toCompareConditionType_Codon_leaderless.png", width = 8, height = 20, units = "cm", dpi = 600)

###### Translation
fscore_avg_HalfLife_logPhase_Translation <- read.table('../ml_metrics_halfLifeClass/HalfLifeCls_logPhase_nonSelected_leaderless_byType_TranslationWTribo_fscore_avg.txt')
fscore_avg_HalfLife_hypoxia_Translation <- read.table('../ml_metrics_halfLifeClass/HalfLifeCls_hypoxia_nonSelected_leaderless_byType_TranslationWTribo_fscore_avg.txt')
...
ggsave("./viz_deltaFscores_toCompareCondition/deltaFscores_avgs_toCompareConditionType_TranslationWTribo_leaderless.png", width = 8, height = 20, units = "cm", dpi = 600)
...
ggsave("./viz_deltaFscores_toCompareCondition/deltaFscores_avgs_toCompareConditionType_Others_leaderless.png", width = 8, height = 20, units = "cm", dpi = 600)

###### combined selected
fscore_avg_HalfLife_logPhase_CombinedSelected <- read.table('../ml_metrics_halfLifeClass/HalfLifeCls_logPhase_combinedSelected_leaderless_byLeaderlessLogPhase_jointlyByLogPhaseHypoxia_fscore_avg.txt')
fscore_avg_HalfLife_hypoxia_CombinedSelected <- read.table('../ml_metrics_halfLifeClass/HalfLifeCls_hypoxia_combinedSelected_leaderless_byLeaderlessLogPhase_jointlyByLogPhaseHypoxia_fscore_avg.txt')
...
ggsave("./viz_deltaFscores_toCompareCondition/deltaFscores_avgs_toCompareConditionType_Combined_CombinedSelectedByLogPhase_leaderless.png", width = 8, height = 20, units = "cm", dpi = 600)
