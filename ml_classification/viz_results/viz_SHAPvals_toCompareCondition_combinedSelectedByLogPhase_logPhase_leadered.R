...
SHAP_vals_Fast <- read.csv('../SHAP_values/SHAPvals_HalfLifeCls_logPhase_combinedSelected_leadered_byLeaderedLogPhase_jointlyByLogPhaseHypoxia_Fast.csv') %>% 
  mutate(class = 'Fast')
SHAP_vals_MedFast <- read.csv('../SHAP_values/SHAPvals_HalfLifeCls_logPhase_combinedSelected_leadered_byLeaderedLogPhase_jointlyByLogPhaseHypoxia_MedFast.csv') %>% 
  mutate(class = 'MedFast')
SHAP_vals_MedSlow <- read.csv('../SHAP_values/SHAPvals_HalfLifeCls_logPhase_combinedSelected_leadered_byLeaderedLogPhase_jointlyByLogPhaseHypoxia_MedSlow.csv') %>% 
  mutate(class = 'MedSlow')
SHAP_vals_Slow <- read.csv('../SHAP_values/SHAPvals_HalfLifeCls_logPhase_combinedSelected_leadered_byLeaderedLogPhase_jointlyByLogPhaseHypoxia_Slow.csv') %>% 
  mutate(class = 'Slow')
...
SHAP_MFE_unfold %>% 
  ...
  coord_flip()
ggsave("./viz_SHAPvalues_toCompareCondition_leadered/SHAPvalueTop20combined_toCompareCondition_HalfLifeCls_logPhase_combinedSelectedByLeaderedLogPhase_jointlyByLogPhaseHypoxia_leadered_MFE_unfold.png", width = 55, height = 22, units = "cm", dpi = 600)
...
SHAP_AAA_CDSnstop %>% 
  ...
  coord_flip()
ggsave("./viz_SHAPvalues_toCompareCondition_leadered/SHAPvalueTop20combined_toCompareCondition_HalfLifeCls_logPhase_combinedSelectedByLeaderedLogPhase_jointlyByLogPhaseHypoxia_leadered_AAA_CDSnstop.png", width = 55, height = 22, units = "cm", dpi = 600)
...
SHAP_ACG_CDSnstop %>% 
  ...
  coord_flip()
ggsave("./viz_SHAPvalues_toCompareCondition_leadered/SHAPvalueTop20combined_toCompareCondition_HalfLifeCls_logPhase_combinedSelectedByLeaderedLogPhase_jointlyByLogPhaseHypoxia_leadered_ACG_CDSnstop.png", width = 55, height = 22, units = "cm", dpi = 600)
...
SHAP_Nucl_A_CDS_5p18nt %>% 
  ...
  coord_flip()
ggsave("./viz_SHAPvalues_toCompareCondition_leadered/SHAPvalueTop20combined_toCompareCondition_HalfLifeCls_logPhase_combinedSelectedByLeaderedLogPhase_jointlyByLogPhaseHypoxia_leadered_Nucl_A_CDS_5p18nt.png", width = 55, height = 22, units = "cm", dpi = 600)
...
SHAP_GC_CDS_5p18nt %>% 
  ...
  coord_flip()
ggsave("./viz_SHAPvalues_toCompareCondition_leadered/SHAPvalueTop20combined_toCompareCondition_HalfLifeCls_logPhase_combinedSelectedByLeaderedLogPhase_jointlyByLogPhaseHypoxia_leadered_GC_CDS_5p18nt.png", width = 55, height = 22, units = "cm", dpi = 600)
...
SHAP_initialAbundance_logPhase %>% 
  ...
  coord_flip()
ggsave("./viz_SHAPvalues_toCompareCondition_leadered/SHAPvalueTop20combined_toCompareCondition_HalfLifeCls_logPhase_combinedSelectedByLeaderedLogPhase_jointlyByLogPhaseHypoxia_leadered_initialAbundance_logPhase.png", width = 55, height = 22, units = "cm", dpi = 600)
...
SHAP_CDS_length %>% 
  ...
  coord_flip()
ggsave("./viz_SHAPvalues_toCompareCondition_leadered/SHAPvalueTop20combined_toCompareCondition_HalfLifeCls_logPhase_combinedSelectedByLeaderedLogPhase_jointlyByLogPhaseHypoxia_leadered_CDS_length.png", width = 55, height = 22, units = "cm", dpi = 600)
...
SHAP_fpr_UTR_length %>% 
  ...
  coord_flip()
ggsave("./viz_SHAPvalues_toCompareCondition_leadered/SHAPvalueTop20combined_toCompareCondition_HalfLifeCls_logPhase_combinedSelectedByLeaderedLogPhase_jointlyByLogPhaseHypoxia_leadered_fpr_UTR_length.png", width = 55, height = 22, units = "cm", dpi = 600)
